...
//List<string> listasDeBandas = new List<string> { "U2", "The Beatles", "Calypso"}; 
...
void ExibirOpcoesDoMenu() 
{
    ...
    switch(opcaoEscolhidaNumerica)
    {
        ...
        case -1: Console.WriteLine("Programa encerrado"); break;
...
void RegistrarBanda()
{
    ...
    //função para dar uma pausa em milisegundos 
    Thread.Sleep(2000);
    Console.Clear() ;
    ExibirOpcoesDoMenu();
}
...
void MostrarBandasRegistradas()
{
    ...
    /*for(int i = 0; i < listasDeBandas.Count; i++)
    {
        Console.WriteLine($"Banda: {listasDeBandas[i]}");
    }*/
